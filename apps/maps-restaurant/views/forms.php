                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-10">
                                    <input type="text" class="form-control" name="title" id="title" maxlength="75" placeholder="Nama Restaurant" required value="<?=$title?>" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <?php if(!empty($photo)) { ?>
                                                <img id="preview_gambar" class="img-view form-control" src="<?php echo base_url('./../assets/restaurant/').$photo ?>" style="width: 40ex;height:40ex">
                                            <?php } else { ?>
                                ...
                                <table id="tab-cert" class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" name="cert_file[]" value="<?=$tt->cert_file?>" class="form-control"/>
                                            </td>
